...
plot(tn,g(tn),'b-o')
xlabel('t'); ylabel('y(t)')
title('Metodo di Crank-Nicolson (h=0.5)')
...
plot(tn,g(tn),'b-o')
xlabel('t'); ylabel('y(t)')
title('Metodo di Crank-Nicolson (h=0.25)')
legend('sol numerica','sol esatta')
...
plot(tn,g(tn),'b-o')
xlabel('t'); ylabel('y(t)')
title('Metodo di Crank-Nicolson (h=0.125)')
legend('sol numerica','sol esatta')
...
figure(4);
loglog(step,Err,'r'); % errore di Crank-Nicolson
hold on
